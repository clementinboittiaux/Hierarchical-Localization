...
if __name__ == '__main__':
    ...
    # features = extract_features.main(feature_conf, images, outputs_vocab)
    features = outputs_vocab / f"{feature_conf['output']}.h5"

    database = outputs_vocab / 'database.db'
    # image_ids = triangulation.create_db_from_model(pycolmap.Reconstruction(reference_sfm), database)
    image_ids = triangulation.create_db_from_model(pycolmap.Reconstruction(global_sfm), database)
