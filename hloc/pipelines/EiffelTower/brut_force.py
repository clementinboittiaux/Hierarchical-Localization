...
if __name__ == '__main__':
    ...
    parser.add_argument('--outputs', type=Path, default='outputs/eiffeltowerresized',
    ...
    query_list = outputs / 'list_query_sample.txt'  # where to save the list of query images
    query_list_with_intrinsics = outputs / 'list_query_with_intrinsics_sample.txt'  # list of query images with intrinsics
    ...
    brut_pairs = outputs / f'pairs-sample-brut-force.txt'  # top-k retrieved by NetVLAD
    loc_pairs = outputs / f'pairs-loc.txt'  # top-k retrieved by NetVLAD
    ...
    #     matcher_conf, brut_pairs, feature_conf['output'], outputs)
    loc_matches = outputs / 'feats-superpoint-n4096-r1024_matches-superglue_pairs-sample-brut-force.h5'

    # pairs_from_brut_force(loc_matches, loc_pairs, num_loc=args.num_loc)

    global_descriptors = extract_features.main(retrieval_conf, dataset / 'global' / 'clahe', outputs)
